    ...
    <div class="container">
        <div class="row">
            ...
            <div class="foot-com foot-2">
                <h5>Телефон: {{ config('app.phone_number', '977-9866893439') }}</h5> </div>
            <div class="foot-com foot-3"><a class="waves-effect waves-light" href="{{'/room_type'}}">Резервирай стая</a> </div>
        </div>
    </div>
</div>
    @show